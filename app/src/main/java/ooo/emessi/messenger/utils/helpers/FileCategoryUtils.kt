...
enum class FileCategoryUtils {
    ...
    companion object {
        ...
        fun getFileCategoryByPath(path: String): FileCategoryUtils {
        ...
        fun getFileCategoryByMime(mimeType: String?): FileCategoryUtils {
            ...
            return if (mimeType.contains("image/")) {
                ...
                FileCategoryUtils.file
            }
        }

        fun getCategoryName(category: FileCategoryUtils, withHtml: Boolean): String {
            when (category) {
        ...
        fun getCategoryByName(name: String): FileCategoryUtils{
            return when (name) {
                image.name -> image
                audio.name -> audio
                video.name -> video
